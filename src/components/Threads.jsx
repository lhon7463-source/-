...
export default function Threads({
  ...
  useEffect(() => {
    ...
    // Use ResizeObserver + window.resize for sizing.
    const resizeObserver = new ResizeObserver(doResize);
    resizeObserver.observe(container);
    window.addEventListener('resize', doResize);

    // Defer initial sizing by one frame so layout has settled
    // (handles edge cases where the container isn't laid out yet).
    ...
    // Only animate while the canvas is on screen, so the shader never
