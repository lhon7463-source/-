...
const projects = [
  {
    ...
    type: 'video',
    tag: 'AI 短片',
    video: '/ai-works/summer/夏日回音.mp4',
    poster: '/ai-works/summer/视频封面.jpg',
    storyboards: [
      '/ai-works/summer/封面.jpg',
      '/ai-works/summer/No.2木.jpg',
      '/ai-works/summer/No.3青.jpg',
      '/ai-works/summer/No.4晨.jpg',
      '/ai-works/summer/No.5雨.jpg',
      '/ai-works/summer/场景2.png',
    ],
  },
  {
    id: 1,
    ...
    type: 'video',
    tag: 'AI 短片',
    video: '/ai-works/cornstar/救命！玉米星君的周末也太像我本人了.mp4',
    poster: '/ai-works/cornstar/玉米星君三视图.jpg',
    storyboards: [
      '/ai-works/cornstar/分镜1.jpg',
      '/ai-works/cornstar/分镜2.jpg',
      '/ai-works/cornstar/分镜3.jpg',
      '/ai-works/cornstar/分镜4.jpg',
      '/ai-works/cornstar/分镜5.jpg',
      '/ai-works/cornstar/分镜6.jpg',
      '/ai-works/cornstar/分镜7.jpg',
      '/ai-works/cornstar/分镜8.jpg',
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    type: 'video',
    tag: 'AI 短片',
    video: '/ai-works/rainy/雨中相遇.mp4',
    poster: '/ai-works/rainy/雨中相遇-封面.jpg',
    storyboards: [
      '/ai-works/rainy/雨中相遇-封面.jpg',
    ],
  },
  {
    id: 4,
    ...
    type: 'video',
    tag: 'AI 动作',
    video: '/ai-works/combat/打斗演示.mp4',
    storyboards: [
      '/ai-works/combat/主角设定图.png',
      '/ai-works/combat/boos设定图.png',
    ],
  },
  {
    id: 5,
    ...
    type: 'video',
    tag: 'AI 短片',
    video: '/ai-works/shuangxiong/双雄决短片.mp4',
    poster: '/ai-works/shuangxiong/封面.jpg',
    storyboards: [
      '/ai-works/shuangxiong/凌云.png',
      '/ai-works/shuangxiong/分镜图1.png',
      '/ai-works/shuangxiong/分镜图2.png',
      '/ai-works/shuangxiong/分镜图3.png',
      '/ai-works/shuangxiong/打斗分镜.png',
      '/ai-works/shuangxiong/裂山.png',
    ],
  },
]
