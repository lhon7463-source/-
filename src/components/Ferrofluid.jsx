...
const Ferrofluid = ({
  ...
  useEffect(() => {
    ...
    const onPointerMove = e => {
      ...
      if (mouseDampening <= 0) uniforms.iMouse.value = [mouseTargetRef.current[0], mouseTargetRef.current[1]]
    }
    ...
    const loop = t => {
      ...
      if (!paused && programRef.current && meshRef.current) {
        try { renderer.render({ scene: meshRef.current }) } catch (e) { /* ignore */ }
      }
    }
    requestAnimationFrame(loop)
